...
from jnerf.models.position_encoders.sh_encoder import SHEncoder
...
class NGPNetworks(nn.Module):
    def __init__(self, use_fully=True, density_hidden_layer=1, density_n_neurons=64, rgb_hidden_layer=2, rgb_n_neurons=64):
        ...
        self.cfg = get_cfg()
        self.using_fp16 = True#self.cfg.fp16
        # self.pos_encoder = build_from_cfg(self.cfg.encoder.pos_encoder, ENCODERS)

        self.pos_encoder = HashEncoder()
        self.dir_encoder = SHEncoder() # build_from_cfg(self.cfg.encoder.dir_encoder, ENCODERS)
